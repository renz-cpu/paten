...
<body>
    ...
    <main>
        ...
        <nav class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                <a class="navbar-brand" href="#section_1">PATEN</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <a href="register" class="btn custom-btn d-lg-block d-none">Daftar</a>
                    <a href="login" class="btn custom-btn d-lg-block d-none">Masuk</a>
                </div>
            </div>
        </nav>
            ...
            <div class="container d-flex justify-content-center align-items-center">
                <div class="row">
                    ...
                    <div class="col-12 mt-auto mb-5 text-center">
                        ...
                        <a class="btn custom-btn" href="#section2">Layanan Tersedia</a>
                    </div>
                    </div>
                </div>
            </div>
        ...
        <section class="container-fluid feature bg-light py-5 mt-1" id="section2">
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-4 col-lg-3 wow fadeInUp mt-costum" data-wow-delay="0.4s" style="margin-top: 15px;">
                        ...
                        <div class="feature-item p-4 pt-0 text-center">
                            ...
                            <a class="btn btn-primary rounded-pill py-2 px-4" href="{{ route('login') }}">Pelayanan tersedia</a>
                        </div>
                    </div>
