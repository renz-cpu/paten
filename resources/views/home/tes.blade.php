...
<link rel="stylesheet" href="https://www.lapor.go.id/combine/123ac454e5c0bbc14ab488c286854934-1732462797">
        ...
        <script src="https://www.lapor.go.id/combine/8d931db45eae6ac902515c50c03fad65-1732462797"></script>
...
<section id="complaint-box">
    ...
    <form data-request="complaint::onCreate" data-request-files data-request-flash class='complaint-form'>
        <input name="_token" type="hidden" value="NxhR49NDxwFdKVGI3LCK1aN2Gp8VoB9cufjHARMw">
        <input name="_session_key" type="hidden" value="oM5cNTmwosOPDbtv9fB6mZQkbWW4gDFXsREkOsdF">
        ...
        <div class="row-flex flex-tablet text-center">
            <div class="post post-counter" style="margin-left: auto;margin-right: auto;">
                <div class="counter-count">
                    <!-- <span class="numscroller" data-min='0' data-max='966165' data-delay='2' data-increment='1000'></span> -->
...
<section class="block block-counter" style="background-image: url(https://www.lapor.go.id/themes/lapor/assets/images/home-map.png);">
    <div class="container">
        ...
        <div class="text-center mg-t-40">
            <a href="https://www.lapor.go.id/instansi" class="btn btn-outline-primary">LIHAT SELENGKAPNYA</a>
        </div>
    </div>
</section>
  ...
  window.onload = function() {
    window.micAccessTool = new MicAccessTool({
      ...
      forceLang: 'en' // default is 'en' may be 'he-IL', 'ru-RU', or 'fr_FR'
        ...
        <form method="POST" action="https://www.lapor.go.id" accept-charset="UTF-8" data-request="laporAuth::onSignin" data-request-update="&#039;captcha-login&#039;: &#039;#google-captcha&#039;"><input name="_session_key" type="hidden" value="oM5cNTmwosOPDbtv9fB6mZQkbWW4gDFXsREkOsdF"><input name="_token" type="hidden" value="NxhR49NDxwFdKVGI3LCK1aN2Gp8VoB9cufjHARMw">
